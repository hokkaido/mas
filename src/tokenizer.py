...
class MagicBertTokenizer(PreTrainedTokenizer):
    r"""
    ...
    def __init__(self, vocab_file, do_lower_case=True, do_basic_tokenize=True, never_split=None,
        ...
        """
        super(MagicBertTokenizer, self).__init__(unk_token=unk_token, sep_token=sep_token,
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *inputs, **kwargs):
        ...
        return super(MagicBertTokenizer, cls)._from_pretrained(pretrained_model_name_or_path, *inputs, **kwargs)
